...
if __name__ == "__main__":
    ...
    #   预训练权重对于99%的情况都必须要用，不用的话主干部分的权值太过随机，特征提取效果不明显，网络训练的结果也不会
    ...
    #----------------------------------------------------------------------------------------------------------------------------#
    # model_path      = 'model_data/yolo3_coco__weights.pth'
    model_path      = 'model_data/darknet53_backbone_weights.pth'
    #------------------------------------------------------#
