...
from carafe import CARAFE_downsample ,CARAFE_upsample
...
class RecoverNet(nn.Module):
    def __init__(self, downsampler,upsampler):
        ...
        self.uplayer3 = nn.Conv2d(32//4 if self.upsampler=='d2s' else 32, 3, kernel_size=3, stride=1, padding=1)
        ...
        elif self.downsampler=='co_dysample':
            self.downsample1 = Dy_DownSample(32)
            self.downsample2 = Dy_DownSample(64)
            self.downsample3 = Dy_DownSample(128)


        elif self.downsampler=='carafe':
            self.downsample1 = CARAFE_downsample(32)
            self.downsample2= CARAFE_downsample(64)
            self.downsample3 = CARAFE_downsample(128)
        ...
        if self.upsampler=='deconv':
            ...
            self.upsample1 = CARAFE_upsample(128)
            self.upsample2 = CARAFE_upsample(64)
            self.upsample3 = CARAFE_upsample(32)
    ...
    def forward(self, input):
        ...
        elif self.downsampler == 'conv'or self.downsampler =='carafe':
        ...
        elif self.upsampler=='deconv'or self.upsampler=='carafe':
            l = self.upsample1(l)
        elif self.upsampler=='co_dysample':
